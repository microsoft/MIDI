...
#define WINDOWS_MIDI_SERVICES_NUGET_BUILD_VERSION_FULL         L"1.0.5.7"
...
#define WINDOWS_MIDI_SERVICES_NUGET_BUILD_VERSION_REVISION     (uint16_t)5
#define WINDOWS_MIDI_SERVICES_NUGET_BUILD_VERSION_BUILD_NUMBER (uint16_t)7
