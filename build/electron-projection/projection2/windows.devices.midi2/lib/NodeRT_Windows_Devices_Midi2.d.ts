declare module "windows.devices.midi2" {
  ...
  export class MidiEndpointConnection {
    ...
    static sendMessageSucceeded(sendResult: MidiSendMessageResult): Boolean;


    static sendMessageFailed(sendResult: MidiSendMessageResult): Boolean;
  ...
  export class MidiEndpointDeviceInformation {
    ...
    supportsMidiPolyphonicExpression: Boolean;
  ...
  export class MidiEndpointDeviceInformationUpdateEventArgs {
