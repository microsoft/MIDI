...
_MidiSendMessageResult = function () {
  this.success = 0;
  this.errorBufferFull = 1;
  this.errorInvalidMessageTypeForWordCount = 2;
  this.errorInvalidMessageOther = 3;
  this.errorSendDataIndexOutOfRange = 4;
  this.errorEndpointConnectionClosedOrInvalid = 5;
  this.errorUnexpected = 6;
}
...
MidiEndpointDeviceInformation = (function () {
  var cls = function MidiEndpointDeviceInformation() {
    ...
    this.uniqueIdentifier = new String();
