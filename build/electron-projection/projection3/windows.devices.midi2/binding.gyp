    ...
    "conditions": [
      ...
      ["USE_ADDITIONAL_WINMD==\"true\"", {
        "msvs_settings": {
          "VCCLCompilerTool": {
            "AdditionalUsingDirectories": [
              "%ProgramFiles%/Windows Kits/10/UnionMetadata/x64",
              "%ProgramFiles%/Windows Kits/10/Include/x64/um",
              "%ProgramFiles(x86)%/Windows Kits/10/UnionMetadata/x64",
              "%ProgramFiles(x86)%/Windows Kits/10/Include/x64/um"
            ]
          }
        }
      }]
