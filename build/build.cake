...
//    const string wixWinrtLibFileName = "[API_INSTALLFOLDER]Windows.Devices.Midi2.dll";
    ...
    using (StreamReader reader = System.IO.File.OpenText(sourceFileName))
    {
        ...
        {
            csWriter.WriteLine("//");
            csWriter.WriteLine("// This file was generated by the build process. Edits to this file will be lost.");
            csWriter.WriteLine("//");
            csWriter.WriteLine("using RegistryCustomActions;");
            csWriter.WriteLine("class RegistryEntries");
            csWriter.WriteLine("{");
            csWriter.WriteLine($"    public static string ApiImplementationLib => \"{MIDI2_NAMESPACE}.dll\";");
            csWriter.WriteLine();
