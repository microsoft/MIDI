...
# Deliberately NOT BundleInfo.wxi: that file is generated by src\build-gen-version-includes and
# is owned by the service/plugins installers, which are a separate release train on a separate
# version. Sharing it means whichever build ran last wins.
