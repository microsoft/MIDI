...
namespace winrt::impl
{
    ...
    struct consume_Microsoft_Windows_Devices_Midi2_IMidiEndpointDeviceInformationStatics
    {
        ...
        auto FindAll(winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformationSortOrder const& sortOrder, winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformationFilters const& endpointFilters) const;
        [[nodiscard]] auto EndpointInterfaceClass() const;
        auto GetAdditionalPropertiesList() const;
        auto DeviceMatchesFilter(winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformation const& deviceInformation, winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformationFilters const& endpointFilters) const;
    };
