...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::MidiVirtualDeviceCreationResult>{ using type = struct_category<bool, hstring>; };
    ...
    template <> inline constexpr auto& name_v<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::MidiVirtualDeviceCreationResult> = L"Microsoft.Windows.Devices.Midi2.Endpoints.Virtual.MidiVirtualDeviceCreationResult";
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::IMidiVirtualDevice>{ 0x2DFFD69C,0x79E9,0x5155,{ 0xBA,0x19,0x55,0x45,0x4E,0x1A,0xDF,0x6D } }; // 2DFFD69C-79E9-5155-BA19-55454E1ADF6D
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::IMidiVirtualDeviceManagerStatics>{ 0x07B07404,0x03A3,0x59A4,{ 0xAB,0x49,0xFD,0x22,0x11,0xBC,0x38,0x04 } }; // 07B07404-03A3-59A4-AB49-FD2211BC3804
    ...
    template <> struct abi<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::IMidiVirtualDevice>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall get_ClientEndpointDeviceId(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::IMidiVirtualDeviceManagerStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall CreateVirtualDevice(void*, struct struct_Microsoft_Windows_Devices_Midi2_Endpoints_Virtual_MidiVirtualDeviceCreationResult*) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Microsoft_Windows_Devices_Midi2_Endpoints_Virtual_IMidiVirtualDevice
    {
        ...
        [[nodiscard]] auto ClientEndpointDeviceId() const;
    ...
    struct struct_Microsoft_Windows_Devices_Midi2_Endpoints_Virtual_MidiVirtualDeviceCreationResult
    {
        bool Success;
        void* DeviceSideEndpointDeviceId;
    };
    template <> struct abi<Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::MidiVirtualDeviceCreationResult>
    {
        using type = struct_Microsoft_Windows_Devices_Midi2_Endpoints_Virtual_MidiVirtualDeviceCreationResult;
    };
}
#endif
