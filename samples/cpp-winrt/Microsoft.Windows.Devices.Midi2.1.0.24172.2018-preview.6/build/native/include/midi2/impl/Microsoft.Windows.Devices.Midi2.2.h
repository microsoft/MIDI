...
WINRT_EXPORT namespace winrt::Microsoft::Windows::Devices::Midi2
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MidiEndpointDeviceInformation : winrt::Microsoft::Windows::Devices::Midi2::IMidiEndpointDeviceInformation
    {
        ...
        static auto FindAll(winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformationSortOrder const& sortOrder, winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformationFilters const& endpointFilters);
        [[nodiscard]] static auto EndpointInterfaceClass();
        static auto GetAdditionalPropertiesList();
        static auto DeviceMatchesFilter(winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformation const& deviceInformation, winrt::Microsoft::Windows::Devices::Midi2::MidiEndpointDeviceInformationFilters const& endpointFilters);
    };
