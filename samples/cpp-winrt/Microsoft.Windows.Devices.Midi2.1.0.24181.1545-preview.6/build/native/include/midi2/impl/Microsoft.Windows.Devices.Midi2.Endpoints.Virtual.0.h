...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::IMidiVirtualDevice>{ 0x95BCDF56,0x519E,0x5E44,{ 0x98,0xF2,0x3B,0x0A,0xE6,0x1F,0x4B,0xC7 } }; // 95BCDF56-519E-5E44-98F2-3B0AE61F4BC7
    template <> inline constexpr guid guid_v<winrt::Microsoft::Windows::Devices::Midi2::Endpoints::Virtual::IMidiVirtualDeviceCreationConfig>{ 0xEF8BC038,0xAC5D,0x5B85,{ 0x88,0x8D,0x11,0xDF,0x01,0x91,0x0D,0xDC } }; // EF8BC038-AC5D-5B85-888D-11DF01910DDC
