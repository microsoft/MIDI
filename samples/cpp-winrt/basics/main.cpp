...
// you need to use the versions packaged with the SDK, use the ones in /build/native/include/midi2
...
#include "midi2init/WindowsMidiServicesClientInitialization.h"
#include "midi2init/WindowsMidiServicesClientInitialization_i.c"
#include "midi2init/MidiDesktopAppSdkBootstrapper.hpp";
// not a WinRT namespace, just a regular C++ namespace, defined in the bootstrapper hpp
