...
| `ImageFileName` | The bare file name of a picture for this endpoint, within the shared endpoint assets folder. The caller is expected to copy the customer's chosen file into that folder and name it here. |
