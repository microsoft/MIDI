...
Interface implemented by strongly-typed WinRT API classes used in configuring transport features. For example, this is used when setting up a virtual device, configuring Network MIDI 2.0 hosts and clients, and creating loopback endpoints.
