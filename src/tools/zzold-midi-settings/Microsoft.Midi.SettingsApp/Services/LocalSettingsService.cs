...
using Microsoft.Midi.SettingsApp.Core.Helpers;
...
namespace Microsoft.Midi.SettingsApp.Services;

public class LocalSettingsService : ILocalSettingsService
{
    private const string _defaultApplicationDataFolder = "Microsoft.Midi.SettingsApp/ApplicationData";
