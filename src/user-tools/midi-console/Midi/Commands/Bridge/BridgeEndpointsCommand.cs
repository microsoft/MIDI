...
namespace Microsoft.Midi.ConsoleApp
{
    ...
    //        {
    //            if (!MidiEndpointDeviceIdHelper.IsPossibleWindowsMidiServicesEndpointDeviceId(settings.EndpointIdA))
    //            {
    ...
    //        {
    //            if (!MidiEndpointDeviceIdHelper.IsPossibleWindowsMidiServicesEndpointDeviceId(settings.EndpointIdB))
    //            {
