...
public partial class ForDevelopersViewModel : ObservableRecipient //, ISettingsSearchTarget
{
    ...
    //    catch (Exception ex)
    //    {
    //        _loggingService.LogError("Error replacing wdmaud2.drv", ex);
    ...
    public ForDevelopersViewModel(IMidiServiceRegistrySettingsService registrySettingsService, ILoggingService loggingService)
    {
