...
namespace Microsoft.Midi.Settings.Views
{
    ...
    /// </summary>
    public sealed partial class EndpointsAppPage : Page
    {
        private ILoggingService _loggingService;


        public EndpointsAppViewModel ViewModel
        {
            get;
        }


        public EndpointsAppPage()
        {
            ViewModel = App.GetService<EndpointsAppViewModel>();
