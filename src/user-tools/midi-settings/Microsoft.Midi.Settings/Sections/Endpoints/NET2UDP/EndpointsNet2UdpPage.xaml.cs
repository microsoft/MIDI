...
namespace Microsoft.Midi.Settings.Views
{
    ...
    /// </summary>
    public sealed partial class EndpointsNet2UdpPage : Page
    {
        private ILoggingService _loggingService;


        public EndpointsNet2UdpViewModel ViewModel
        {
            get;
        }


        public EndpointsNet2UdpPage()
        {
            ViewModel = App.GetService<EndpointsNet2UdpViewModel>();
