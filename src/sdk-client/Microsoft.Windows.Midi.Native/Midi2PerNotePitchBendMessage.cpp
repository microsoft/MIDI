...
namespace Microsoft::Windows::Midi::Messages
{
	...
	Midi2PerNotePitchBendMessage Midi2PerNotePitchBendMessage::FromValues(const uint8_t group, const uint8_t channel, const uint8_t noteNumber, const uint32_t data)
	{
