...
if ($confirmation -eq 'y' -or $confirmation -eq 'Y')
{
    ...
    $wdmaud2SystemPath = $env:systemroot + "\SysWOW64\wdmaud2.drv"
    $wdmaud2SystemBakPath = $env:systemroot + "\SysWOW64\wdmaud2.bak"
    ...
    {
        Write-Host "Taking ownership of 32-bit wdmaud2.drv..." -ForegroundColor DarkCyan
        ...
        Write-Host "Copying over the new 32-bit wdmaud2.drv..." -ForegroundColor DarkCyan
