...
```
sc create "MIDI Services Dev" binpath="f:\ull\path\to\MidiService.exe"
```

example:

```
sc create "MIDI Services Dev" binpath="D:\OneDrive - Microsoft\Audio\MIDI Dev Scratch\MidiService\MidiService\bin\Release\net7.0\win-x64\publish\MidiService.exe"
```

Optional step

```
sc description "MIDI Services Dev" "In-development version of Windows MIDI Services"
```
...
```
sc start "MIDI Services Dev"

sc stop "MIDI Services Dev"
```
