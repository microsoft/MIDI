...
#pragma once
#include "VirtualPatchBay.MidiVirtualPatchBayRouteUpdateConfig.g.h"

namespace winrt::Windows::Devices::Midi2::VirtualPatchBay::implementation
{
...
namespace winrt::Windows::Devices::Midi2::VirtualPatchBay::factory_implementation
{
