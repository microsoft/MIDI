...
namespace winrt::Windows::Devices::Midi2::implementation
{
    ...
    midi2::MidiMessage128 MidiMessage128::CreateFromStruct(
        ...
        MidiMessageStruct const& message) noexcept
    {
        ...
        catch (winrt::hresult_error const& ex)
        {
            ...
            TraceLoggingWrite(
                ...
                TraceLoggingWideString(L"hresult error creating MidiMessage128 from struct.", MIDI_SDK_TRACE_MESSAGE_FIELD),
        ...
        catch (...)
        {
            ...
            TraceLoggingWrite(
                ...
                TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
                TraceLoggingPointer(nullptr, MIDI_SDK_TRACE_THIS_FIELD),
                TraceLoggingWideString(L"General exception creating MidiMessage128 from struct.", MIDI_SDK_TRACE_MESSAGE_FIELD)
            );
