...
#pragma once
#include "Enumeration.MidiFunctionBlock.g.h"
...
namespace winrt::Windows::Devices::Midi2::Enumeration::implementation
{
    struct MidiFunctionBlock : MidiFunctionBlockT<MidiFunctionBlock>
    {
        ...
        midi2enum::MidiFunctionBlockDirection Direction() const noexcept { return m_direction; }
        void Direction(_In_ midi2enum::MidiFunctionBlockDirection const value) noexcept { if (!m_isReadOnly) m_direction = value; }

        midi2enum::MidiFunctionBlockUIHint UIHint() const noexcept { return m_uiHint; }
        void UIHint(_In_ midi2enum::MidiFunctionBlockUIHint const value) noexcept { if (!m_isReadOnly) m_uiHint = value; }

        midi2enum::MidiFunctionBlockRepresentsMidi10Connection RepresentsMidi10Connection() const noexcept { return m_midi10Connection; }
        void RepresentsMidi10Connection(_In_ midi2enum::MidiFunctionBlockRepresentsMidi10Connection const value) noexcept { if (!m_isReadOnly) m_midi10Connection = value; }
