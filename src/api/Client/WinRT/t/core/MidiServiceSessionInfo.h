...
namespace winrt::Windows::Devices::Midi2::Reporting::implementation
{
    struct MidiServiceSessionInfo : MidiServiceSessionInfoT<MidiServiceSessionInfo>
    {
        ...
        collections::IVectorView<rpt::MidiServiceSessionConnectionInfo> Connections() { return m_connections.GetView(); }
        ...
        void InternalAddConnection(
            _In_ rpt::MidiServiceSessionConnectionInfo const& info
        );
    ...
    private:
        ...
        foundation::Collections::IVector<rpt::MidiServiceSessionConnectionInfo>
            m_connections{ winrt::single_threaded_vector<rpt::MidiServiceSessionConnectionInfo>() };
