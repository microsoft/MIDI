...
#pragma once
#include "Enumeration.MidiGroupTerminalBlock.g.h"
...
namespace winrt::Windows::Devices::Midi2::Enumeration::implementation
{
    struct MidiGroupTerminalBlock : MidiGroupTerminalBlockT<MidiGroupTerminalBlock>
    {
        ...
        midi2enum::MidiGroupTerminalBlockDirection Direction() { return (midi2enum::MidiGroupTerminalBlockDirection)m_block.Direction; }
        midi2enum::MidiGroupTerminalBlockProtocol Protocol() { return (midi2enum::MidiGroupTerminalBlockProtocol)m_block.Protocol; }

        midi2::MidiGroup FirstGroup() const noexcept { return midi2::MidiGroup(m_block.FirstGroupIndex); }
        ...
        midi2enum::MidiFunctionBlock AsEquivalentFunctionBlock();
