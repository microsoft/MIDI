...
namespace winrt::Windows::Devices::Midi2::ClientPlugins::implementation
{
    struct MidiGroupEndpointListener : MidiGroupEndpointListenerT<MidiGroupEndpointListener>
    {
        ...
        void PluginTag(_In_ foundation::IInspectable const& value) noexcept { m_tag = value; }
...
namespace winrt::Windows::Devices::Midi2::ClientPlugins::factory_implementation
{
