...
#define MIDIDIAG_SECTION_LABEL_FEATURE_ENABLEMENT                        "feature_enablement"
#define MIDIDIAG_FIELD_LABEL_ENABLED_FEATURE                             "enabled_feature"
#define MIDIDIAG_FIELD_LABEL_DISABLED_FEATURE                            "disabled_feature"
