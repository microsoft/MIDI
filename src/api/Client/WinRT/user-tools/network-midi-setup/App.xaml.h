...
namespace winrt::midinetworksetup::implementation
{
    struct App : AppT<App>
    {
        ...
        static ::midinetworksetup::CommandLineOptions const& StartupOptions() noexcept { return s_startupOptions; }
    ...
    private:
        ...
        static ::midinetworksetup::CommandLineOptions s_startupOptions;
