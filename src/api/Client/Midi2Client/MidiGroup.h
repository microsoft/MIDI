...
namespace MIDI_CPP_NAMESPACE::implementation
{
    struct MidiGroup : MidiGroupT<MidiGroup>
    {
        ...
        static winrt::hstring LabelShort() { return internal::ResourceGetHString(IDS_MIDI_COMMON_LABEL_GROUP_SHORT); }
        static winrt::hstring LabelFull() { return internal::ResourceGetHString(IDS_MIDI_COMMON_LABEL_GROUP_FULL); }
