...
void MidiLegacyPortDeviceWatcherTests::TestCreateAndEnumerateForFlow()
{
   // auto watcher = winrt::Windows::Devices::Midi2::Enumeration::Legacy::MidiLegacyPortDeviceWatcher::CreateForFlow(Midi1PortFlow::MidiMessageDestination);
