...
#include "pch.h"
#include "BluetoothMidiValidationTests.h"
...
bool BluetoothMidiValidationTests::ClassSetup()
{
...
bool BluetoothMidiValidationTests::ClassCleanup()
{
    return true;
}


void BluetoothMidiValidationTests::TestSafeGetObjectRejectsEveryWrongType()
{
...
void BluetoothMidiValidationTests::TestSafeGetObjectAcceptsAnObject()
{
...
void BluetoothMidiValidationTests::TestSafeGetArrayRejectsEveryWrongType()
{
...
void BluetoothMidiValidationTests::TestSafeGetArrayAcceptsAnArray()
{
...
void BluetoothMidiValidationTests::TestSafeGetStringRejectsEveryWrongType()
{
...
void BluetoothMidiValidationTests::TestSafeGetStringAcceptsAString()
{
...
void BluetoothMidiValidationTests::TestSafeGetBooleanRejectsEveryWrongType()
{
...
void BluetoothMidiValidationTests::TestSafeGetBooleanAcceptsABoolean()
{
...
void BluetoothMidiValidationTests::TestSafeAccessorsToleratePresentButNullValues()
{
...
void BluetoothMidiValidationTests::TestSafeAccessorsTolerateAMissingKey()
{
...
void BluetoothMidiValidationTests::TestWellFormedDeviceIdAcceptsATwelveDigitAddress()
{
...
void BluetoothMidiValidationTests::TestWellFormedDeviceIdAcceptsSeparatedForms()
{
...
void BluetoothMidiValidationTests::TestWellFormedDeviceIdRejectsWrongLengths()
{
...
void BluetoothMidiValidationTests::TestWellFormedDeviceIdRejectsNonHex()
{
...
void BluetoothMidiValidationTests::TestWellFormedDeviceIdRejectsEmptyAndSeparatorsOnly()
{
...
void BluetoothMidiValidationTests::TestWellFormedDeviceIdRejectsAVeryLongValue()
{
...
void BluetoothMidiValidationTests::TestParseAddressAcceptsAFullAddress()
{
    uint64_t address{ 0 };
...
void BluetoothMidiValidationTests::TestParseAddressIsDeliberatelyLenientAboutLength()
{
...
void BluetoothMidiValidationTests::TestParseAddressRejectsNonHexAndOverlongValues()
{
    uint64_t address{ 0 };
...
void BluetoothMidiValidationTests::TestFormatAddressAlwaysProducesTwelveUpperCaseDigits()
{
...
void BluetoothMidiValidationTests::TestFormatAddressDiscardsBitsAboveFortyEight()
{
...
void BluetoothMidiValidationTests::TestAddressRoundTripsThroughFormatAndParse()
{
...
void BluetoothMidiValidationTests::TestProtocolStringsRoundTrip()
{
    VERIFY_ARE_EQUAL(
...
void BluetoothMidiValidationTests::TestNativeDataFormatStrings()
{
    VERIFY_ARE_EQUAL(
...
void BluetoothMidiValidationTests::TestConnectionParameterPreferenceStringsRoundTrip()
{
...
void BluetoothMidiValidationTests::TestConnectionParameterPreferenceFallsBackOnUnknownValue()
{
    auto const parsed = MidiBleUtilities::ConnectionParameterPreferenceFromJsonString(
...
void BluetoothMidiValidationTests::TestApprovalScopeStringsRoundTrip()
{
...
void BluetoothMidiValidationTests::TestApprovalScopeRejectsAnUnrecognizedValue()
{
...
void BluetoothMidiValidationTests::TestApprovalScopeTreatsEmptyAsOnce()
{
    MidiBleProtocol::ApprovalScope parsed{ MidiBleProtocol::ApprovalScope::Always };
...
void BluetoothMidiValidationTests::TestClientPolicyDefaultsToRequiringApproval()
{
...
void BluetoothMidiValidationTests::TestClientPolicyStringsRoundTrip()
{
...
void BluetoothMidiValidationTests::TestClientMatchKeyIgnoresSeparatorsAndCase()
{
...
void BluetoothMidiValidationTests::TestClientMatchKeyOfAnUnusableAddressIsEmpty()
{
...
void BluetoothMidiValidationTests::TestClientDecisionStrings()
{
    VERIFY_ARE_EQUAL(
...
void BluetoothMidiValidationTests::TestRandomAddressKindComesFromTheTopTwoBits()
{
...
void BluetoothMidiValidationTests::TestPublicAddressIsAlwaysRememberable()
{
...
void BluetoothMidiValidationTests::TestStaticRandomAddressIsRememberable()
{
...
void BluetoothMidiValidationTests::TestPrivateRandomAddressIsNotRememberableUnlessPaired()
{
...
void BluetoothMidiValidationTests::TestUnspecifiedAddressTypeIsNotRememberableUnlessPaired()
{
...
void BluetoothMidiValidationTests::TestEveryTransportErrorCodeIsDistinct()
{
