...
HRESULT
CMidi2EndpointMetadataListenerMidiBiDi::Initialize(
    LPCWSTR EndpointId,
...
HRESULT
CMidi2EndpointMetadataListenerMidiBiDi::Cleanup()
{
    TraceLoggingWrite(
        MidiEndpointMetadataListenerAbstractionTelemetryProvider::Provider(),
        __FUNCTION__,
...
_Use_decl_annotations_
HRESULT
CMidi2EndpointMetadataListenerMidiBiDi::SendMidiMessage(
    PVOID Message,
    UINT Size,
    LONGLONG Timestamp
)
...
_Use_decl_annotations_
HRESULT
CMidi2EndpointMetadataListenerMidiBiDi::Callback(
    PVOID Message,
    UINT Size,
    LONGLONG Timestamp,
    LONGLONG
