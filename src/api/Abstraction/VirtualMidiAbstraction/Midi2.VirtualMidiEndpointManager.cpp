...
{
    UNREFERENCED_PARAMETER(jsonObject);



    // parse the json and perform the create/update/remove operations detailed in it
...
json::JsonObject GetCreateNode(json::JsonObject Parent)
{
...
HRESULT CMidi2VirtualMidiEndpointManager::CreateClientVisibleEndpoint(
    GUID const VirtualEndpointAssociationGuid,
    std::wstring DeviceSideInstanceId,
    std::wstring const Name,
    std::wstring const LargeImagePath,
    std::wstring const SmallImagePath,
    std::wstring const Description,
    /* out */ std::wstring InstanceId
)
{
    UNREFERENCED_PARAMETER(VirtualEndpointAssociationGuid);
    UNREFERENCED_PARAMETER(DeviceSideInstanceId);
    UNREFERENCED_PARAMETER(Name);
    UNREFERENCED_PARAMETER(LargeImagePath);
    UNREFERENCED_PARAMETER(SmallImagePath);
