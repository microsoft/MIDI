...
#include "pch.h"
#include "midi2.BluetoothMidiTransport.h"
...
_Use_decl_annotations_
void
CMidi2BluetoothMidiEndpointManager::OnAdvertisementWatcherStopped(
...
HRESULT
CMidi2BluetoothMidiEndpointManager::StartGattServiceWatcher()
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
    ...
    try
    {
        ...
        m_deviceWatcherAddedToken = m_deviceWatcher.Added({ this, &CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherAdded });
        m_deviceWatcherUpdatedToken = m_deviceWatcher.Updated({ this, &CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherUpdated });
        m_deviceWatcherRemovedToken = m_deviceWatcher.Removed({ this, &CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherRemoved });
        m_deviceWatcherStoppedToken = m_deviceWatcher.Stopped({ this, &CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherStopped });
...
_Use_decl_annotations_
void
CMidi2BluetoothMidiEndpointManager::OnAdvertisementReceived(
    bt::Advertisement::BluetoothLEAdvertisementWatcher const&,
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherAdded(
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherRemoved(
    enumeration::DeviceWatcher const&,
    enumeration::DeviceInformationUpdate const& args
)
{
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::OnDeviceWatcherStopped(
    enumeration::DeviceWatcher const&,
...
_Use_decl_annotations_
void
CMidi2BluetoothMidiEndpointManager::QueueNameResolutionIfNeeded(winrt::hstring const& deviceId)
{
    {
...
_Use_decl_annotations_
bool
CMidi2BluetoothMidiEndpointManager::TryGetDiscoveredDevice(
...
_Use_decl_annotations_
void
CMidi2BluetoothMidiEndpointManager::UpdateDiscoveredDeviceConnectionState(
    winrt::hstring const& deviceId,
...
CMidi2BluetoothMidiEndpointManager::GetDeviceIdsWithUnresolvableNames()
{
    auto lock = std::scoped_lock{ m_pendingRequestsLock };
...
CMidi2BluetoothMidiEndpointManager::GetDiscoveredDevices()
{
    auto const now = NowInMilliseconds();
...
_Use_decl_annotations_
bool
CMidi2BluetoothMidiEndpointManager::IsDeviceNameable(winrt::hstring const& deviceId)
{
    {
        auto lock = std::scoped_lock{ m_discoveredDevicesLock };
...
HRESULT
CMidi2BluetoothMidiEndpointManager::ConnectConfiguredDevices()
{
    RETURN_HR_IF(E_UNEXPECTED, !m_initialized);
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::StartPeripheral(MidiBleProtocol::Protocol const protocol)
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
void
CMidi2BluetoothMidiEndpointManager::OnPeripheralClientChanged()
{
    {
        auto lock = std::scoped_lock{ m_pendingRequestsLock };
...
HRESULT
CMidi2BluetoothMidiEndpointManager::StopPeripheral()
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
HRESULT
CMidi2BluetoothMidiEndpointManager::RemovePeripheralEndpoint()
{
...
HRESULT
CMidi2BluetoothMidiEndpointManager::ProcessPeripheralClientChange()
{
    auto peripheral = TransportState::Current().GetPeripheral();
...
HRESULT
CMidi2BluetoothMidiEndpointManager::WakeupBackgroundEndpointCreatorThread()
{
...
HRESULT
CMidi2BluetoothMidiEndpointManager::StartBackgroundEndpointCreator()
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::EndpointCreatorWorker(std::stop_token stopToken)
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::ConnectDeviceInternal(winrt::hstring const& deviceId)
{
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::ConnectDeviceCore(
    winrt::hstring const& deviceId,
    winrt::hstring& failureDetail,
    uint32_t& errorCode
)
...
_Use_decl_annotations_
void
CMidi2BluetoothMidiEndpointManager::RecordConnectResult(
    winrt::hstring const& deviceId,
    HRESULT const hr,
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::ResolveDeviceNameInternal(winrt::hstring const& deviceId)
{
    MidiBleProtocol::DiscoveredDevice discoveredDevice{};
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::DisconnectDeviceInternal(winrt::hstring const& deviceId)
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::CreateEndpointForConnection(std::shared_ptr<MidiBleConnection> connection)
{
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::RefreshMidi1PortsForRenamedEndpoint(
...
_Use_decl_annotations_
winrt::hstring
CMidi2BluetoothMidiEndpointManager::FindMatchingInstantiatedEndpoint(
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::DeleteEndpoint(
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::InitiateDiscoveryAndNegotiation(
...
_Use_decl_annotations_
HRESULT
CMidi2BluetoothMidiEndpointManager::QueueDiscoveryAndNegotiation(
    std::wstring const& endpointDeviceInterfaceId
)
{
    RETURN_HR_IF(E_INVALIDARG, endpointDeviceInterfaceId.empty());
...
HRESULT
CMidi2BluetoothMidiEndpointManager::Shutdown()
{
    TraceLoggingWrite(
        MidiBluetoothMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
