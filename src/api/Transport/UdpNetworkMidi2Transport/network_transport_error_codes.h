...
// transport settings
#define NETWORK_ERROR_CODE_FEC_PACKET_COUNT_OUT_OF_RANGE            0x00000081
#define NETWORK_ERROR_CODE_RETRANSMIT_BUFFER_SIZE_OUT_OF_RANGE      0x00000082
#define NETWORK_ERROR_CODE_PING_INTERVAL_OUT_OF_RANGE               0x00000083
#define NETWORK_ERROR_CODE_MAX_HOST_CONNECTIONS_OUT_OF_RANGE        0x00000084
#define NETWORK_ERROR_CODE_INVITATION_PENDING_TIMEOUT_OUT_OF_RANGE  0x00000085
#define NETWORK_ERROR_CODE_SCAN_INTERVAL_OUT_OF_RANGE               0x00000086
