...
{
    RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2KSMidiEndpointManager>(&m_endpointManager));
...
{
    RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2KSMidiConfigurationManager>(&m_configurationManager));
