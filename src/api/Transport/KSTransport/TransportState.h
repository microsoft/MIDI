...
public:
    ...
    wil::com_ptr<CMidi2KSMidiEndpointManager> GetEndpointManager()
    {
        return m_endpointManager;
    }

    wil::com_ptr<CMidi2KSMidiConfigurationManager> GetConfigurationManager()
    {
...
private:
    ...
    wil::com_ptr<CMidi2KSMidiEndpointManager> m_endpointManager;
    wil::com_ptr<CMidi2KSMidiConfigurationManager> m_configurationManager;
