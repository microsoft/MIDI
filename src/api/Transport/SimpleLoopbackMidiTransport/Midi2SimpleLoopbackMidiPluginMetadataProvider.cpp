...
HRESULT
CMidi2SimpleLoopbackMidiPluginMetadataProvider::Initialize()
{
    return S_OK;
}
...
HRESULT
CMidi2SimpleLoopbackMidiPluginMetadataProvider::GetMetadata(
...
HRESULT
CMidi2SimpleLoopbackMidiPluginMetadataProvider::Shutdown()
{
    return S_OK;
}