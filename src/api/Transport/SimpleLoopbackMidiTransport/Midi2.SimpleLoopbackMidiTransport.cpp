...
HRESULT
CMidi2SimpleLoopbackMidiTransport::Activate(
    REFIID Riid,
    void **Interface
)
{
    ...
    else if (__uuidof(IMidiServiceTransportPluginMetadataProvider) == Riid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2SimpleLoopbackMidiPluginMetadataProvider>(&metadataProvider));
