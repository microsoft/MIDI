...
HRESULT
CMidi2SimpleLoopbackMidiConfigurationManager::Initialize(
    GUID transportId,
...
_Use_decl_annotations_
HRESULT
CMidi2SimpleLoopbackMidiConfigurationManager::ProcessCommand(
...
_Use_decl_annotations_
HRESULT
CMidi2SimpleLoopbackMidiConfigurationManager::UpdateConfiguration(
...
)
{
    ...
    try
    {
        ...
        std::wstring instanceIdPrefix = MIDI_SIMPLE_LOOP_INSTANCE_ID_PREFIX;
        ...
        if (createObject != nullptr && createObject.Size() > 0)
        {
            ...
            while (o.HasCurrent())
            {
                std::shared_ptr<MidiSimpleLoopbackDeviceDefinition> definition = std::make_shared<MidiSimpleLoopbackDeviceDefinition>();
...
HRESULT
CMidi2SimpleLoopbackMidiConfigurationManager::Shutdown()
{
    TraceLoggingWrite(
        MidiSimpleLoopbackMidiTransportTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
