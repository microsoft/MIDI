...
{
    RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2SimpleLoopbackMidiEndpointManager>(&m_endpointManager));
...
{
    RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2SimpleLoopbackMidiConfigurationManager>(&m_configurationManager));
