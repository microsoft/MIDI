...
HRESULT
CMidi2BasicLoopbackMidiTransport::Activate(
    REFIID Riid,
    void **Interface
)
{
    ...
    if (__uuidof(IMidiBidirectional) == Riid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2BasicLoopbackMidiBidi>(&midiBidi));
    ...
    else if (__uuidof(IMidiServiceTransportPluginMetadataProvider) == Riid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2BasicLoopbackMidiPluginMetadataProvider>(&metadataProvider));
