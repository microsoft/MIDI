...
#define BASIC_LOOPBACK_ERROR_CODE_ENDPOINT_REMOVAL_FAILED   0x00000022

#define BASIC_LOOPBACK_ERROR_CODE_MISSING_ASSOCIATION_ID    0x00000031
#define BASIC_LOOPBACK_ERROR_CODE_INVALID_ASSOCIATION_ID    0x00000032
...
#define BASIC_LOOPBACK_ERROR_CODE_UNIQUE_ID_TOO_LONG        0x00000145
#define BASIC_LOOPBACK_ERROR_CODE_INVALID_UNIQUE_ID         0x00000146
