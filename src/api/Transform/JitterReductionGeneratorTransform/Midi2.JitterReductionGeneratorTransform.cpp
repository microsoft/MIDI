...
HRESULT
CMidi2JitterReductionGeneratorTransform::Activate(
    REFIID Iid,
    void **Interface
)
{
    ...
    if (__uuidof(IMidiDataTransform) == Iid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2JitterReductionGeneratorMidiTransform>(&midiTransform));
