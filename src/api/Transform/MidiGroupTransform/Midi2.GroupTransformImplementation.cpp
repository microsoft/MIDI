...
#include "Midi2.GroupTransformImplementation.h"

#include "ump_iterator.h"

_Use_decl_annotations_
HRESULT
CMidi2GroupTransformImplementation::Initialize(
...
{
    TraceLoggingWrite(
        Midi2GroupTransformTelemetryProvider::Provider(),
...
HRESULT
CMidi2GroupTransformImplementation::Shutdown()
{
    TraceLoggingWrite(
        Midi2GroupTransformTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
_Use_decl_annotations_
HRESULT
CMidi2GroupTransformImplementation::SendMidiMessage(
