...
#pragma once
#include "MidiInputEndpointOpenOptions.g.h"


namespace winrt::Windows::Devices::Midi2::implementation
{
    struct MidiInputEndpointOpenOptions : MidiInputEndpointOpenOptionsT<MidiInputEndpointOpenOptions>
    {
    public:
        MidiInputEndpointOpenOptions() = default;
...
{
    struct MidiInputEndpointOpenOptions : MidiInputEndpointOpenOptionsT<MidiInputEndpointOpenOptions, implementation::MidiInputEndpointOpenOptions>
    {
    };
}
