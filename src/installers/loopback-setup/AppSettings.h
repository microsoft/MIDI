...
namespace midiloopbacksetup
{
    ...
    public:
        ...
        // how often the pages ask the service for the current set of loopbacks
        ...
        // Basic is page 0: it is the loopback style most customers already know, so it is what
        // the tool opens on when there is no stored preference.
        static constexpr uint32_t PageIndexBasicLoopbacks = 0;
        static constexpr uint32_t PageIndexLoopbacks = 1;
