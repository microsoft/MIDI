...
namespace WindowsMidiServices
{
    public class MidiEndpointConnection
    {
        ...
        internal Windows.Devices.Midi2.MidiEndpointConnection? BackingConnection { get; set; }
        ...
        public MidiEndpointConnection(Windows.Devices.Midi2.MidiEndpointConnection backingConnection)
        {
        ...
        private void BackingConnection_MessageReceived(Windows.Devices.Midi2.IMidiMessageReceivedEventSource sender, Windows.Devices.Midi2.MidiMessageReceivedEventArgs args)
        {
