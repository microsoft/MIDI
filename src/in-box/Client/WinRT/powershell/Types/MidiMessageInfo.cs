...
namespace WindowsMidiServices
{
    public class MidiMessageInfo
    {
        ...
        public Windows.Devices.Midi2.MidiMessageType MessageType { get; internal set; }

        public Windows.Devices.Midi2.MidiPacketType PacketType { get; internal set; }
        ...
        public Windows.Devices.Midi2.MidiGroup? Group { get; internal set; } = null;
        public Windows.Devices.Midi2.MidiChannel? Channel { get; internal set; } = null;
    }
}
