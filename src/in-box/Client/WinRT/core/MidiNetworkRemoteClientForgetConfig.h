...
#pragma once
#include "Transports.Network.MidiNetworkRemoteClientForgetConfig.g.h"

namespace winrt::Windows::Devices::Midi2::Transports::Network::implementation
{
    struct MidiNetworkRemoteClientForgetConfig : MidiNetworkRemoteClientForgetConfigT<MidiNetworkRemoteClientForgetConfig>
    {
        MidiNetworkRemoteClientForgetConfig() = default;

        MidiNetworkRemoteClientForgetConfig(
...
{
    struct MidiNetworkRemoteClientForgetConfig : MidiNetworkRemoteClientForgetConfigT<MidiNetworkRemoteClientForgetConfig, implementation::MidiNetworkRemoteClientForgetConfig>
    {
    };
}
