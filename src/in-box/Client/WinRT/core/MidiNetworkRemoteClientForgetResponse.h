...
#pragma once
#include "Transports.Network.MidiNetworkRemoteClientForgetResponse.g.h"

namespace winrt::Windows::Devices::Midi2::Transports::Network::implementation
{
    struct MidiNetworkRemoteClientForgetResponse : MidiNetworkRemoteClientForgetResponseT<MidiNetworkRemoteClientForgetResponse>
    {
        MidiNetworkRemoteClientForgetResponse() = default;
        ...
        network::MidiNetworkRemoteClientForgetErrorCode ErrorCode() const noexcept { return m_errorCode; }
        ...
        void InternalSetError(_In_ network::MidiNetworkRemoteClientForgetErrorCode const errorCode, _In_ winrt::hstring const& errorMessage) noexcept
        {
            m_success = false;
        ...
        {
            m_success = true;
            m_errorCode = network::MidiNetworkRemoteClientForgetErrorCode::NoErrorInformationAvailable;
            m_errorMessage = L"";
        }
    ...
    private:
        ...
        network::MidiNetworkRemoteClientForgetErrorCode m_errorCode{};
