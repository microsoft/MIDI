...
#pragma once
#include "Transports.Loopback.MidiLoopbackRemovalResponse.g.h"

namespace winrt::Windows::Devices::Midi2::Transports::Loopback::implementation
{
    struct MidiLoopbackRemovalResponse : MidiLoopbackRemovalResponseT<MidiLoopbackRemovalResponse>
    {
        MidiLoopbackRemovalResponse() = default;
