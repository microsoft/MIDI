...
#pragma once
#include "Transports.Virtual.MidiStreamConfigRequestReceivedEventArgs.g.h"
...
namespace winrt::Windows::Devices::Midi2::Transports::Virtual::implementation
{
    struct MidiStreamConfigRequestReceivedEventArgs : MidiStreamConfigRequestReceivedEventArgsT<MidiStreamConfigRequestReceivedEventArgs>
    {
        ...
        midi2enum::MidiProtocol PreferredMidiProtocol() { return m_protocol; }
        ...
        void InternalInitialize(
            ...
            _In_ midi2enum::MidiProtocol protocol,
    ...
    private:
        ...
        midi2enum::MidiProtocol m_protocol{ midi2enum::MidiProtocol::Default };
