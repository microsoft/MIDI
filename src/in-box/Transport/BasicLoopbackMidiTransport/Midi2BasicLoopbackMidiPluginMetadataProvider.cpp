...
HRESULT
CMidi2BasicLoopbackMidiPluginMetadataProvider::Initialize()
{
    return S_OK;
}
...
HRESULT
CMidi2BasicLoopbackMidiPluginMetadataProvider::GetMetadata(
...
HRESULT
CMidi2BasicLoopbackMidiPluginMetadataProvider::Shutdown()
{
    return S_OK;
}