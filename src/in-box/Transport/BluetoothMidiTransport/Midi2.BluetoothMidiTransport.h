...
class MidiBluetoothMidiTransportTelemetryProvider : public wil::TraceLoggingProvider
{
    IMPLEMENT_TRACELOGGING_CLASS_WITH_MICROSOFT_TELEMETRY(
        MidiBluetoothMidiTransportTelemetryProvider,
...
class ATL_NO_VTABLE CMidi2BluetoothMidiTransport :
    public CComObjectRootEx<CComMultiThreadModel>,
    public CComCoClass<CMidi2BluetoothMidiTransport, &CLSID_Midi2BluetoothMidiTransport>,
    public IMidiTransport
{
public:
    CMidi2BluetoothMidiTransport()
    {
    }

    DECLARE_REGISTRY_RESOURCEID(IDR_MIDI2BLE2MIDITRANSPORT)

    BEGIN_COM_MAP(CMidi2BluetoothMidiTransport)
...
OBJECT_ENTRY_AUTO(__uuidof(Midi2BluetoothMidiTransport), CMidi2BluetoothMidiTransport)