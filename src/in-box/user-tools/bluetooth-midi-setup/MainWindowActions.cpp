...
namespace winrt::midibluetoothsetup::implementation
{
    ...
    winrt::fire_and_forget MainWindow::OnBrowseForImageClick(foundation::IInspectable const&, xaml::RoutedEventArgs const&)
    {
        ...
        try
        {
            ...
            {
                SetDevicesStatus(res::GetString(L"StatusImageCopyFailed"));
        ...
        MIDI_BTSETUP_CATCH_AND_LOG(L"Unable to choose an image.")
    }
    ...
    void MainWindow::OnRemoveImageClick(foundation::IInspectable const&, xaml::RoutedEventArgs const&)
    {
        ...
        MIDI_BTSETUP_CATCH_AND_LOG(L"Unable to clear the image.")
    }
