...
namespace winrt::midibluetoothsetup::implementation
{
    struct App : AppT<App>
    {
        ...
        static ::midibluetoothsetup::CommandLineOptions const& StartupOptions() noexcept { return s_startupOptions; }
    ...
    private:
        ...
        static ::midibluetoothsetup::CommandLineOptions s_startupOptions;
