...
namespace winrt::midiloopbacksetup::implementation
{
    struct App : AppT<App>
    {
        ...
        static ::midiloopbacksetup::CommandLineOptions const& StartupOptions() noexcept { return s_startupOptions; }
    ...
    private:
        ...
        static ::midiloopbacksetup::CommandLineOptions s_startupOptions;
