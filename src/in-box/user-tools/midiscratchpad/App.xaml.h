...
namespace winrt::midiscratchpad::implementation
{
    struct App : AppT<App>
    {
        ...
        static ::midiscratchpad::CommandLineOptions const& StartupOptions() noexcept { return s_startupOptions; }
    ...
    private:
        ...
        static ::midiscratchpad::CommandLineOptions s_startupOptions;
