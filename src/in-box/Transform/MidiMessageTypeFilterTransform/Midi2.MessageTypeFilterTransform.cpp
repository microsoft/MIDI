...
#include "Midi2.MessageTypeFilterTransform.h"


_Use_decl_annotations_
HRESULT
CMidi2MessageTypeFilterTransform::Activate(
    REFIID iid,
...
)
{
    ...
    if (__uuidof(IMidiDataTransform) == iid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2MessageTypeFilterTransformImplementation>(&midiTransform));
