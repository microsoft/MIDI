...
#include "Midi2.GroupTransform.h"


_Use_decl_annotations_
HRESULT
CMidi2GroupTransform::Activate(
    REFIID iid,
...
)
{
    ...
    if (__uuidof(IMidiDataTransform) == iid)
    {
        ...
        RETURN_IF_FAILED(Microsoft::WRL::MakeAndInitialize<CMidi2GroupTransformImplementation>(&midiTransform));
