...
#include "Midi2.ChannelTransformImplementation.h"

#include "ump_iterator.h"

_Use_decl_annotations_
HRESULT
CMidi2ChannelTransformImplementation::Initialize(
...
{
    TraceLoggingWrite(
        Midi2ChannelTransformTelemetryProvider::Provider(),
...
HRESULT
CMidi2ChannelTransformImplementation::Shutdown()
{
    TraceLoggingWrite(
        Midi2ChannelTransformTelemetryProvider::Provider(),
        MIDI_TRACE_EVENT_INFO,
...
_Use_decl_annotations_
HRESULT
CMidi2ChannelTransformImplementation::SendMidiMessage(
