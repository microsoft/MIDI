...
TEST_CASE("Connected.Endpoint.MultipleUmpWords Send and receive multiple words")
{
    ...
    for (uint32_t i = 0; i < numMessagesToSend; i++)
    {
        ...
        {
            words[0] = 0x20000000;
            wordCount = (uint32_t)(winrt::Windows::Devices::Midi2::MidiUmpPacketType::Ump32);
        ...
        {
            words[0] = 0x40000000;
            wordCount = (uint32_t)(winrt::Windows::Devices::Midi2::MidiUmpPacketType::Ump64);
        }
        break;
        case 2:
        {
            words[0] = 0xB0000000;
            wordCount = (uint32_t)(winrt::Windows::Devices::Midi2::MidiUmpPacketType::Ump96);
        }
        break;
        case 3:
        {
            words[0] = 0xF0000000;
            wordCount = (uint32_t)(winrt::Windows::Devices::Midi2::MidiUmpPacketType::Ump128);
        }
        break;
        }
