...
#define DEFAULT_LOOPBACK_BIDI_NAME L"MIDI 2.0 Loopback (BiDi)"

#define DEFAULT_LOOPBACK_OUT_ID L"MIDIU_LOOPBACK_DEFAULT_OUT"
#define DEFAULT_LOOPBACK_OUT_NAME L"MIDI 2.0 Loopback (Out)"

#define DEFAULT_LOOPBACK_IN_ID L"MIDIU_LOOPBACK_DEFAULT_IN"
#define DEFAULT_LOOPBACK_IN_NAME L"MIDI 2.0 Loopback (In)"
