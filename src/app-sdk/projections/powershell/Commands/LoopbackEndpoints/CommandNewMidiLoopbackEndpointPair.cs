...
namespace WindowsMidiServices
{
    ...
    public class CommandNewMidiLoopbackEndpointPair : Cmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var creationConfig = new MidiLoopbackEndpointCreationConfig(guid, loopbackA, loopbackB);
            
            try
            {
                var createdEndpoint = MidiLoopbackEndpointManager.CreateTransientLoopbackEndpoints(creationConfig);
