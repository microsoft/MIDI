...
#pragma once
#include "Reporting.MidiServiceSessionInfo.g.h"
...
namespace winrt::Microsoft::Windows::Devices::Midi2::Reporting::implementation
{
    struct MidiServiceSessionInfo : MidiServiceSessionInfoT<MidiServiceSessionInfo>
    {
        ...
        collections::IVectorView<rept::MidiServiceSessionConnectionInfo> Connections() { return m_connections.GetView(); }
        ...
        void InternalAddConnection(
            _In_ rept::MidiServiceSessionConnectionInfo const& info
        );
    ...
    private:
        ...
        foundation::Collections::IVector<rept::MidiServiceSessionConnectionInfo>
            m_connections{ winrt::single_threaded_vector<rept::MidiServiceSessionConnectionInfo>() };
