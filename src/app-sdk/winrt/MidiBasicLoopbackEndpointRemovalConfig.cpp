...
#include "Endpoints.BasicLoopback.MidiBasicLoopbackEndpointRemovalConfig.g.cpp"
...
namespace winrt::Microsoft::Windows::Devices::Midi2::Endpoints::BasicLoopback::implementation
{
    ...
    MidiBasicLoopbackEndpointRemovalConfig::MidiBasicLoopbackEndpointRemovalConfig(winrt::guid const& associationId)
    {
